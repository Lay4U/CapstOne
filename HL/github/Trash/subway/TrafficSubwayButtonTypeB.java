...
public class TrafficSubwayButtonTypeB
  ...
  implements View.OnClickListener
{
  ...
  public TrafficSubwayButtonTypeB(Context context) {
    super(context);
    initView();
  }
  
  public TrafficSubwayButtonTypeB(Context context, AttributeSet attrs) {
    super(context, attrs);
    initView();
  }
  
  public TrafficSubwayButtonTypeB(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView();
  }
  
  @TargetApi(21)
  public TrafficSubwayButtonTypeB(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  private void initView() {
    ...
    View view = layoutInflater.inflate(R.layout.traffic_subway_button_type_b, this, false);
  ...
  {
    Intent intent = new Intent(getContext(), TrafficSubwayDetailTypeB.class);
